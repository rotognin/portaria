<form class="col-12" method="post" action="index.php?control=movimentacao&action=<?php echo $acao; ?>">
    ...
    <div class="form-group">
        ...
        <input type="number" id="id" name="id" readonly value="<?php echo ($movimentacao->id ?? '0'); ?>">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="placa" style="margin:0px"><b>Placa veículo: &nbsp;</b></label><br>
    ...
    <div class="form-group">
        <label for="contato"><b>Contato interno:&nbsp;</b></label><br>
        <input type="text" id="contato" name="contato" value="<?php echo ($movimentacao->contato ?? ''); ?>" size="100">
    </div>
    <div class="form-group">
        <label for="motivo"><b>Motivo:&nbsp;</b></label><br>
        <input type="text" id="motivo" name="motivo" value="<?php echo ($movimentacao->motivo ?? ''); ?>" size="100">
    </div>
    <div class="form-group">
